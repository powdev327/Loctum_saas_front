...
export default function UserInfoCard() {
  ...
  return (
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        ...
        {isUpdateModal && <ClientUpdate isOpen={isUpdateModal} openModal={isOpenUpdateModal} closeModal={isCloseUpdateModal} clientId={client?.client_id} client={client}
        />}

        {isStoringModal && <ClientAddManager isOpen={isStoringModal} openModal={isOpenStoringModal} closeModal={isCloseStoringModal}
        />}
      </div>
  );
}