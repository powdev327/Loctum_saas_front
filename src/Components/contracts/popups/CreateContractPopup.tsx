      ...
      This field is required. Please select an institution.
            ...
            This field is required. Please select a contract type.
                            ...
                            <BaseFields
                                ...
                                selectedInstitution={institutionOptions.find((opt) => opt.value === formState.institution_id) || null}
                            ...
                            {formState.contract_type === "PLACEMENT" && (
                                <PlacementFieldsComponent
                                    ...
                                    handleChange={handleChange}
                                    submissionAttempted={submissionAttempted}
                                    feesEnabled={institutions.find((inst) => inst.institution_id === formState.institution_id)?.fees_enabled || false}
                    ...
                    <div className="p-6 bg-white rounded-lg dark:bg-gray-800">
                                            ...
                                            <div className="flex items-center gap-2 mt-2 pl-7">
                                                    ...
                                                    <Select
                                                        ...
                                                        onChange={(newValue) => {
                                                            handleChange('daily_hours', {
                                                                ...
                                                                [date]: {
                                                                    ...dayHours,
                                                                    start_time: newValue || "09:00", // newValue est une string
                                                                },
                                                            });
                                                        }}
                                                    />
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <Select
                                                        className="w-full"
                                                        options={hourOptions}
                                                        value={endTime} // string, pas un objet
                                                        onChange={(newValue) => {
                                                            handleChange('daily_hours', {
                                                                ...formState.daily_hours,
                                                                [date]: {
                                                                    ...dayHours,
                                                                    end_time: newValue || "17:00", // newValue est string
                                                                },
                                                            });
                                                        }}
                                                    />
                        ...
                        <div className="flex justify-between mt-4">
                            <Button
                                ...
                                size="sm"
                                onClick={() => {
                                    const resetHours = dateRange.reduce((acc, date) => ({
                                        ...acc,
                                        [date]: {
                                            enabled: true,
                                            start_time: "09:00",
                            ...
                            <Button
                                size="sm"
                                onClick={() => setIsWorkHoursPopupOpen(false)}
                            >
                                Save Changes
                            </Button>
                        </div>
